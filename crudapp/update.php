...
<div class="my-centertext">
	...
	<div class="jumbotron">
  <h1 class="display-4"><center>UPDATE THE INFO<center></h1>
  <p class="lead"><center>
  	<font size="+3">
...
<center>
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" placeholder="First name" name="ufname" required>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control"  placeholder="Last name" name="ulname"  required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control"  placeholder="Date" name="udate"required>
      <div class="invalid-feedback">
...
if (isset($_POST['submit'])) {
  ...
  $upquary = "UPDATE users SET f_name = '$first_name',l_name='$last_name',email='$email',date='$date_of_birth' WHERE id=$update_id";
...
alert('THANK U FORE USING CRUD APP');
